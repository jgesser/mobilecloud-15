...
public class Utils {
	...
	/**
	 * Return an uppercase version of the input or null if user gave no input. If user gave no input and @a showToast is
	 * true a toast is displayed to this effect.
	 */
