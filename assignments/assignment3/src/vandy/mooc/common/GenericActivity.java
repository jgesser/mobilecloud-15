...
/**
 * This Activity provides a framework that automatically handles runtime configuration changes in conjunction with an
 * instance of OpsType, which must implement the ConfigurableOps interface. It also extends LifecycleLoggingActivity so
 * that all lifecycle hook method calls are automatically logged.
 */
