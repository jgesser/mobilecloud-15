...
/**
 * UploadVideoDialog Fragment shows user a Dialog that lists various means of uploading a Video.
 */
public class UploadVideoDialogFragment extends DialogFragment {
	 ...
	 */
	private String[] listItems = { "Video Gallery", "Record a Video" };

	/**
	 * Callback that will send the result to Activity that implements it, when the Option is selected.
	 */
	...
	/**
	 * Hook method called when a fragment is first attached to its activity. onCreate(Bundle) will be called after this.
	 * 
	 * @param activity
	 */
	@Override
	...
	/**
	 * This method will be called after onCreate(Bundle) and before onCreateView(LayoutInflater, ViewGroup, Bundle). The
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		builder.setTitle(R.string.title_upload_video).setItems(listItems,
				//Set OnClick listener for the Dialog.
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						UploadVideoDialogFragment.OperationType type = UploadVideoDialogFragment.OperationType.values()[which];
