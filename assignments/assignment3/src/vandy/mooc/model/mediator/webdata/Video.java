...
/**
 * This "Plain Ol' Java Object" (POJO) class represents meta-data of interest downloaded in Json from the Video Service
 * via the VideoServiceProxy.
 */
public class Video {
	/**
	 ...
	 */
	public Video(long id, String title, long duration, String contentType, String dataUrl) {
		this.id = id;
		this.title = title;
		this.duration = duration;
		this.contentType = contentType;
	...
	public String toString() {
		return "{" + "Id: " + id + ", " + "Title: " + title + ", " + "Duration: " + duration + ", " + "ContentType: " + contentType + ", " + "Data URL: " + dataUrl + "}";
	}
	...
	/**
	 * @return Compares this Video instance with specified Video and indicates if they are equal.
	 */
	@Override
