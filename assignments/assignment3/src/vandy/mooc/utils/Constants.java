...
/**
 * Class that contains all the Constants required in our Video Upload client App.
 */
public class Constants {
	/**
	 * URL of the VideoWebService. Please Read the Instructions in README.md to set up the SERVER_URL.
	 */
