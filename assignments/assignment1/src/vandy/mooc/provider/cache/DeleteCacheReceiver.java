...
/**
 * Broadcast receiver that will remove all the expired acronyms at regular intervals.
 *
 */
public class DeleteCacheReceiver extends BroadcastReceiver {
	...
	/**
	 * Factory method to make a Pending Intent that is used by AlarmManager to schedule Cache cleanup at regular
	 * intervals.
	 *
	 * @param context
	 * @return
	...
	public static PendingIntent makeReceiverPendingIntent(Context context) {
		...
		return PendingIntent.getBroadcast(context, DELETE_CACHE_REQUEST_CODE, new Intent(context, DeleteCacheReceiver.class), PendingIntent.FLAG_CANCEL_CURRENT);
	}
	...
	public static PendingIntent makeCheckAlarmPendingIntent(Context context) {
		...
		return PendingIntent.getBroadcast(context, DELETE_CACHE_REQUEST_CODE, new Intent(context, DeleteCacheReceiver.class), PendingIntent.FLAG_NO_CREATE);
	}

	/**
	 * Hook method that is called when the BroadcastReceiver is receiving an Intent broadcast.
	 */
	@Override
	public void onReceive(Context context, Intent intent) {
		// Create the TimeoutCache and remove all the expired acronyms
		// from the cache.
		// TODOne -- you fill in here by calling the appropriate method in
